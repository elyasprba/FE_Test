...
function ETollTunaiFlo({ selectedDate, search }: { selectedDate: string, search: string }) {
    ...
    const transformedData = (() => {
        ...
        listLalin.data.rows.rows.forEach((item: any) => {
            ...
            const tunai = item.Tunai || 0;
            const flo = item.eFlo || 0;
            const total = etoll + tunai + flo;
